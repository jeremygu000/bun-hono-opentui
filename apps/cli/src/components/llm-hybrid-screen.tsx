...
export function LlmHybridScreen() {
  ...
  return (
    <box
      ...
      width="100%"
    >
      <text fg="#7aa2f7">LLM Hybrid</text>
      <text fg="#888888">server uses streamText + createTextStreamResponse</text>
      <text fg="#888888">client uses fetch + ReadableStream</text>
